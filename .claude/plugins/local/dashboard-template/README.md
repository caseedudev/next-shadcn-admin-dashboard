...
| `/dashboard-template:review-frontend` | 프론트엔드 코드 리뷰 (frontend-architect 에이전트에 위임) |
| `/dashboard-template:review-backend` | 백엔드 코드 리뷰 (backend-architect 에이전트에 위임) |
